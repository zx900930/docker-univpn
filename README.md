...
## Included Software Information (Version: 10781.21.0.0831)

| Field           | Value                                                               |
| :-------------- | :------------------------------------------------------------------ |
| Release         | **10781.21.0.0831**                                                 |
| Binary Location | Included in repository: `./bin/univpn-linux-64-10781.21.0.0831.zip` |
